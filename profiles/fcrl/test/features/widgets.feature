...
Feature: Widgets
  ...
  Scenario: Adds "Visualization embed" block to home page using panels ipe editor
    ...
    And I fill in "edit-remote-source" with "http://demo.getfcrl.com/node/7/recline-embed#{view-graph:{graphOptions:{hooks:{processOffset:{},bindEvents:{}}}},graphOptions:{hooks:{processOffset:{},bindEvents:{}}}}"
    And I press "Finish"
