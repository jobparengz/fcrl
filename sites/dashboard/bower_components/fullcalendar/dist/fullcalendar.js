	...
	if (moment.isMoment(input) || isNativeDate(input) || input === undefined) {
		...
		if (isSingleString) {
			if (ambigDateOfMonthRegex.test(input)) {
				// accept strings like '2017-05', but convert to the first of the month
				input += '-01';
...
var View = FC.View = ChronoComponent.extend({
	...
	computeTitleFormat: function() {
		if (this.currentRangeUnit == 'year') {
			...
			return this.opt('monthYearFormat'); // like "September 2017"
		}
		else if (this.currentRangeAs('days') > 1) {
			return 'll'; // multi-day range. shorter, like "Sep 9 - 10 2017"
		}
		else {
			return 'LL'; // one day. longer, like "September 9 2017"
		}
	},
...
var dpComputableOptions = {
	...
	// Produces format strings like "MMMM YYYY" -> "September 2017"
