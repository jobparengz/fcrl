# This script initiates a behat test session for any of the fcrl development
...
require "pp"
require "base64"
require "./fcrl/.ahoy/.scripts/behat-parse-params"

BEHAT_FOLDER = ENV.has_key?("BEHAT_FOLDER") ? ENV["BEHAT_FOLDER"] : "docroot/profiles/fcrl/test"
...
def main
  ...
  if payload.include? SKIP_COMPOSER_FLAG
    ...
    `bash fcrl/.ahoy/.scripts/composer-install.sh #{BEHAT_FOLDER}`
  end
