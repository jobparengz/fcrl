 ...
 */
class FcrlDatastoreAPITest extends \PHPUnit_Framework_TestCase {
   ...
   * Query test.
   */
  public function test_fcrl_datstore_api_query() {
    $params = array(
      'resource_id' => array(
    ...
    $params = fcrl_datastore_api_get_params($params);
    $result = fcrl_datastore_api_query($params);
   ...
   */
  public function test_fcrl_datstore_api_filters_array_format() {
  ...
  public function test_fcrl_fcrl_datastore_api_filters_array_multivalue_format() {
  ...
  public function test_fcrl_datstore_api_filters_prefixed_table() {
  ...
  public function test_fcrl_datstore_api_filters_prefixed_table_mixed() {
    $filters = array('gold_prices' => array('date' => '1950-02-01'));
    $params = self::getFilterParams($filters);
    $result = fcrl_datastore_api_query($params);
  }
  ...
  public static function getFilterParams($filters) {
    ...
    return fcrl_datastore_api_get_params($params);
  }

  /**
   * Offset test.
   */
  public function test_fcrl_datstore_api_offset() {
    $params = array(
      'resource_id' => array(
   ...
   * Limit test.
   */
  public function test_fcrl_datstore_api_limit() {
    $params = array(
      'resource_id' => array(
        'gold_prices_states' => self::getUUID('gold_prices_states', self::getResources()),
      ),
   ...
   * Fields test.
   */
  public function test_fcrl_datstore_api_fields() {
    $params = array(
      'resource_id' => array(
        'gold_prices_states' => self::getUUID('gold_prices_states', self::getResources()),
      ),
   ...
   * Sort test.
   */
  public function test_fcrl_datstore_api_sort() {
    $params = array(
      'resource_id' => array(
        'gold_prices_states' => self::getUUID('gold_prices_states', self::getResources()),
      ),
   ...
   * Group by test.
   */
  public function test_fcrl_datstore_api_group_by() {
    $params = array(
      'resource_id' => array(
        'gold_prices' => self::getUUID('gold_prices', self::getResources()),
      ),
   ...
   * Join test.
   */
  public function test_fcrl_datstore_api_join() {
    $params = array(
      'resource_id' => array(
        'gold_prices_states' => self::getUUID('gold_prices_states', self::getResources()),
        'gold_prices' => self::getUUID('gold_prices', self::getResources()),
   ...
   */
  public function test_fcrl_datstore_api_join_with_filters() {
    $params = array(
      'resource_id' => array(
        'gold_prices_states' => self::getUUID('gold_prices_states', self::getResources()),
        'gold_prices' => self::getUUID('gold_prices', self::getResources()),
   ...
   * Multiquery test.
   */
  public function test_fcrl_datstore_api_multiquery() {
    $queries = array(
      'my_query' => array(
        'resource_id' => array(
    ...
    $result = fcrl_datastore_api_multiple_query($queries);
   ...
   * Test aggregations
   */
  public function test_fcrl_datstore_api_aggregations() {
   ...
   */
  public function test_fcrl_fcrl_datastore_api_empty_is_null() {
    $params = array(
      'resource_id' => array(
