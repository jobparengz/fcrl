 ...
 */
class RawFCRLContext extends RawDrupalContext implements FCRLAwareInterface {
  ...
  /**
   * @var \Drupal\FCRLExtension\ServiceContainer\EntityStore
   */
  protected $entityStore;
  /**
   * @var \Drupal\FCRLExtension\ServiceContainer\PageStore
   */
  protected $pageStore;
  /**
