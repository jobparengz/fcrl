 ...
 */
  ...
  // -----------------------
  // - MONTHLY ACCOMPLISHMENTS CHART -
  // -----------------------

  // Get context with jQuery - using jQuery's .get() method.
  var accomplishmentChartCanvas = $('#accomplishmentChart').get(0).getContext('2d');
  // This will get the first returned node in the jQuery collection.
  var accomplishmentChart = new Chart(accomplishmentChartCanvas);
  
  var accomplishmentChartData = {
  ...
  var accomplishmentChartOptions = {
  ...
  accomplishmentChart.Line(accomplishmentChartData, accomplishmentChartOptions);

  // ---------------------------
  // - END MONTHLY ACCOMPLISHMENTS CHART -
  // ---------------------------
