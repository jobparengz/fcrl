...
/**
 * @file
 * File for fcrl_harvest HarvestSourceType class.
 *
...
class HarvestSourceType {
   ...
   *        FCRL Harvest source type machine name.
   *
   * @throws Exception
  ...
  public static function getSourceType($machine_name) {
    $source_types = fcrl_harvest_source_types_definition();
