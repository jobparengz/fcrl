...
/**
 * @file
 * Test transition emails for the fcrl_workflow via fcrl_workflow_mail_alter.
 *
...
/**
 * Unit tests for fcrl_workflow_mail_alter.
 */
class FcrlWorkflowMailAlterTest extends PHPUnit_Framework_TestCase {
  ...
  public function testOrigUserOfNodePasses() {
    ...
    fcrl_workflow_mail_alter($this->message);
