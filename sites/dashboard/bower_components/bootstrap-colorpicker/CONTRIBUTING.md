...
- Before posting your issue, consider adding this information:
  ...
  * A link to your JSFiddle (or similar tool) mis where you reproduced the problem (if applicable).
...
- Check that the index.html miss aren't broken (modify if necessary).
- Test your code at least in Chrome, Firefox and IE >= 10 / Edge.
- Any new feature should come with updated docs if applicable (a misnstration).
