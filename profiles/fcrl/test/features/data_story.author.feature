...
Feature: Data Stories
  ...
  Background:
    ...
    And "fcrl_data_story" content:
      | title                           | author      | status   |
      | FCRL Data Story Test Story Post | Jaz001         | 1        |
  ...
  Scenario: Create Story Content
    ...
    When I am on "/node/add/fcrl-data-story"
  ...
  Scenario: Edit own story content
    And I am logged in as "Jaz001"
    When I am on "story/fcrl-data-story-test-story-post"
    And I click "Edit"
    And I fill in "body[und][0][value]" with "Test description Update"
    And I press "Save"
    Then I should see "FCRL Data Story Test Story Post has been updated"
