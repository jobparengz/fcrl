...
Feature: Users with Editor, Content Creator or Site Manager roles should not have access to administration pages.
  ...
  Background:
    Given pages:
      ...
      # Fcrl Data Story content type related pages.
      | edit fcrl_data_story content type                | /admin/structure/types/manage/fcrl-data-story                    |
      | delete fcrl_data_story content type              | /admin/structure/types/manage/fcrl-data-story/delete             |
      | manage fcrl_data_story content type fields       | /admin/structure/types/manage/fcrl-data-story/fields             |
      | manage fcrl_data_story content type display      | /admin/structure/types/manage/fcrl-data-story/display            |
  ...
  Examples:
    ...
    | add content types                                |
    # Fcrl Data Story content type related pages.
    | edit fcrl_data_story content type                |
    | delete fcrl_data_story content type              |
    | manage fcrl_data_story content type fields       |
    | manage fcrl_data_story content type display      |
    # Data Dashboard content type related pages.
