          ...
          if (!this.inited) x(l.defQueueMap, c) || this.fetch();
            ...
            if (1 > this.depCount && !this.defined) {
              ...
              if (this.map.isDefine && !this.ignore && (v[c] = h, g.onResourceLoad)) { var f = [];
                ...
                g.onResourceLoad(l, this.map, f) } C(c);
              this.defined = !0
            }
            this.defining = !1;
      ...
      callPlugin: function() {
        ...
        w(d, "defined", z(this, function(h) {
          ...
          if (this.map.unnormalized) {
            ...
            M && (S = !1);
            u(f);
            x(p.config, b) && (p.config[d] = p.config[b]); try { g.exec(h) } catch (e) { return A(F("fromtexteval", "fromText eval for " + b + " failed: " + e, e, [b])) } M && (S = !0);
            this.depMaps.push(f);
            l.completeLoad(d);
      ...
      enable: function() {
        ...
        y(this.depMaps, z(this, function(a,
          b) { var c, h; if ("string" === typeof a) { a = q(a, this.map.isDefine ? this.map : this.map.parentMap, !1, !this.skipMap);
            this.depMaps[b] = a; if (c = e(R, a.id)) { this.depExports[b] = c(this); return } this.depCount += 1;
            w(a, "defined", z(this, function(a) { this.undefed || (this.defineDep(b, a), this.check()) }));
            this.errback ? w(a, "error", z(this, this.errback)) : this.events.error && w(a, "error", z(this, function(a) { this.emit("error", a) })) } c = a.id;
          h = t[c];
