...
class HarvestCacheTest extends PHPUnit_Framework_TestCase {
  ...
  public $processed = array(
    array(
      'title' => 'Test entrie',
      'flag' => HarvestCache::FCRL_HARVEST_CACHE_PROCESSED,
    ),
    array(
      'title' => 'Test entrie',
      'flag' => HarvestCache::FCRL_HARVEST_CACHE_PROCESSED,
    ...
    array(
      'title' => 'Test entrie',
      'flag' => HarvestCache::FCRL_HARVEST_CACHE_FAILED,
    ),
    array(
      'title' => 'Test entrie filtered 1',
      'flag' => HarvestCache::FCRL_HARVEST_CACHE_FILTERED,
    ),
    array(
      'title' => 'Test entrie filtered 1',
      'flag' => HarvestCache::FCRL_HARVEST_CACHE_FILTERED,
    ...
    array(
      'title' => 'Test entrie',
      'flag' => HarvestCache::FCRL_HARVEST_CACHE_EXCLUDED,
    ),
    array(
      'title' => 'Test entrie',
      'flag' => HarvestCache::FCRL_HARVEST_CACHE_EXCLUDED,
    ...
    array(
      ...
      'flag' => HarvestCache::FCRL_HARVEST_CACHE_FILTERED | HarvestCache::FCRL_HARVEST_CACHE_DEFAULTED,
    ),
    array(
      'title' => 'Test entrie overridden 1',
      'flag' => HarvestCache::FCRL_HARVEST_CACHE_FILTERED | HarvestCache::FCRL_HARVEST_CACHE_OVERRIDDEN,
    ),
    array(
      'title' => 'Test entrie overridden 2',
      'flag' => HarvestCache::FCRL_HARVEST_CACHE_OVERRIDDEN | HarvestCache::FCRL_HARVEST_CACHE_FILTERED,
    ),
    array(
      'title' => 'Test entrie overridden 3',
      'flag' => HarvestCache::FCRL_HARVEST_CACHE_PROCESSED | HarvestCache::FCRL_HARVEST_CACHE_OVERRIDDEN,
    ),
  );
  ...
  public function testProccessed() {
    $harvestSource = new HarvestSourceDataJsonStub(__DIR__ . '/data/fcrl_harvest_datajson_test_original.json');
  ...
  public function testFailed($harvestCache) {
    $failed = array_filter($this->processed, function ($entry) {
      return ($entry['flag'] == HarvestCache::FCRL_HARVEST_CACHE_FAILED);
    });
  ...
  public function testFiltered($harvestCache) {
    $filtered = array_filter($this->processed, function ($entry) {
      return ($entry['flag'] & HarvestCache::FCRL_HARVEST_CACHE_FILTERED);
    });
  ...
  public function testExcluded($harvestCache) {
    $excluded = array_filter($this->processed, function ($entry) {
      return ($entry['flag'] == HarvestCache::FCRL_HARVEST_CACHE_EXCLUDED);
    });
  ...
  public function testDefaulted($harvestCache) {
    $defaulted = array_filter($this->processed, function ($entry) {
      return ($entry['flag'] == (HarvestCache::FCRL_HARVEST_CACHE_FILTERED | HarvestCache::FCRL_HARVEST_CACHE_DEFAULTED));
    });
  ...
  public function testOverridden($harvestCache) {
    $overridden = array_filter($this->processed, function ($entry) {
      return ($entry['flag'] == (HarvestCache::FCRL_HARVEST_CACHE_OVERRIDDEN | HarvestCache::FCRL_HARVEST_CACHE_FILTERED));
    });
