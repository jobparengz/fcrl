...
namespace Drupal\FCRLExtension\Context\Annotation;
...
class Reader implements AnnotationReader {
   ...
   * @var string
   */
  private static $regex = '/^\@(beforenodecreate|afternodecreate|beforetermcreate|aftertermcreate|beforeusercreate|afterusercreate|beforefcrlentitycreate|afterfcrlentitycreate)(?:\s+(.+))?$/i';
  ...
  private static $classes = array(
    ...
    'beforefcrlentitycreate' => 'Drupal\FCRLExtension\Hook\Call\BeforeFCRLEntityCreate',
    'afterfcrlentitycreate' => 'Drupal\FCRLExtension\Hook\Call\AfterFCRLEntityCreate',
  );
