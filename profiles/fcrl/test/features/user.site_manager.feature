...
Feature: User command center links for site manager role.
  ...
  Scenario: Site manager role can view admin menu links under Add Content, FCRL, Visualizations, People and Site Configuration
    ...
    #FCRL
    When I hover over the admin menu item "FCRL"
    Then I hover over the admin menu item "FCRL Dataset Forms"
