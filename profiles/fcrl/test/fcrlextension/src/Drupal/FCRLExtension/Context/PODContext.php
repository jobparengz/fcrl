...
use Drupal\FCRLExtension\Context\PageContext;
 ...
 */
class PODContext extends RawFCRLContext {
  ...
  public function iShouldSeeLicenseValues($option) {
    // Get the list of licenses provided by FCRL.
    $licenses = fcrl_dataset_content_types_license_allowed_values();
