 ...
 */
function fishcoral_project_link_iframe_formatter_original($variables) {
 ...
 */
function fishcoral_project_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function fishcoral_project_facetapi_link_inactive($variables) {
 ...
 * @ingroup themeable
 */
function fishcoral_project_facetapi_link_active($variables) {
  // Sanitizes the link text if necessary.
  $sanitize = empty($variables['options']['html']);
 ...
 * Theme social icons.
 */
function fishcoral_project_sitewide_social_block() {
 ...
 */
function fishcoral_project_file_widget($variables) {
 ...
 * assets/stylesheets/fcrl-topics.css.
 */
function fishcoral_project_facet_icons($variables) {
  ...
  $classes[] = 'icon-fcrl-' . check_plain($variables['type']);
  $classes = implode(' ', $classes);
  return '<span class="icon-fcrl ' . $classes . '" ' . drupal_attributes($attributes) . '></span>';
}
