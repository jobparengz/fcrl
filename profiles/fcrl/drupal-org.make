...
core: 7.x
includes:
- https://raw.githubusercontent.com/MiS/visualization_entity/7.x-2.0/visualization_entity.make
- https://raw.githubusercontent.com/MiS/open_data_schema_map/7.x-2.0/open_data_schema_map.make
- https://raw.githubusercontent.com/MiS/leaflet_draw_widget/5a5f8faf664aeca02371f6692307580d9fab9116/leaflet_widget.make
- https://raw.githubusercontent.com/MiS/recline/7.x-2.0/recline.make
projects:
  admin_menu:
    version: 3.0-rc5
  admin_menu_source:
  ...
  feeds_flatstore_processor:
    download:
      type: git
      url: https://github.com/GetFCRL/feeds_flatstore_processor.git
  ...
  leaflet_draw_widget:
    download:
      type: git
      url: https://github.com/GetFCRL/leaflet_draw_widget.git
  ...
  linkchecker:
    ...
    patch:
      ...
      1: patches/fcrl_linkchecker_file.patch
  manualcrop:
    version: '1.6'
  markdown:
    version: '1.5'
  ...
  open_data_schema_map:
    download:
      type: git
      url: https://github.com/GetFCRL/open_data_schema_map.git
      tag: 7.x-2.0
  panelizer:
    version: '3.4'
  panels:
  ...
  recline:
    download:
      type: git
      url: https://github.com/GetFCRL/recline.git
      tag: 7.x-2.0
  ref_field:
    download:
      type: git
  ...
  remote_stream_wrapper:
    download:
      type: git
      url: https://github.com/GetFCRL/remote_stream_wrapper.git
  ...
  taxonomy_fixtures:
    download:
      type: git
      url: https://github.com/GetFCRL/taxonomy_fixtures.git
  ...
  visualization_entity:
    download:
      type: git
      url: https://github.com/GetFCRL/visualization_entity.git
      tag: 7.x-2.0
    type: module
  workbench:
    version: '1.2'
...
libraries:
  ...
  spectrum:
    download:
      type: git
      url: https://github.com/GetFCRL/spectrum.git
