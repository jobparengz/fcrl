# time:0m16s
Feature: Homepage
  In order to know all the features provided by Fcrl
  As a website user
  I need to be able to see default content

  @api
  Scenario: All default content should be loaded
    Given I enable the module "fcrl_default_content"
    ...
    And all default content with type "node" and bundle "fcrl_data_story" listed in "fcrl_data_story" fixture should "be loaded"
  ...
  Scenario: All default content should be removed if the module is disabled
    Given I disable the module "fcrl_default_content"
    ...
    And all default content with type "node" and bundle "fcrl_data_story" listed in "fcrl_data_story" fixture should "not be loaded"
  ...
  Scenario: Enable the default content module back
    ...
    Then I enable the module "fcrl_default_content"