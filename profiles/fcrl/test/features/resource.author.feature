...
Feature: Resource
  ...
  Scenario: Create resource
    ...
    And I fill in "edit-field-link-remote-file-und-0-filefield-fcrl-remotefile-url" with "https://s3.amazonaws.com/fcrl-default-content-files/files/datastore-simple.csv"
  ...
  Scenario: Create resource with too many sources.
    ...
    And I click "Resource"
    And I click "Remote file"
    And I fill in "edit-field-link-remote-file-und-0-filefield-fcrl-remotefile-url" with "https://s3.amazonaws.com/fcrl-default-content-files/files/datastore-simple3.csv"
  ...
  @resource_author_06 @fcrlBug @noworkflow
  ...
  @resource_author_14 @fcrlBug @noworkflow
  ...
  Scenario: Import items on datastore of own resource
    ...
    And I click "Edit"
    And I click "Remote file"
    And I fill in "edit-field-link-remote-file-und-0-filefield-fcrl-remotefile-url" with "https://s3.amazonaws.com/fcrl-default-content-files/files/datastore-simple4.csv"
    And I press "Save"
    And I am on "Resource 01" page
  ...
  Scenario: Delete items on datastore of own resource
    ...
    And I click "Edit"
    And I click "Remote file"
    And I fill in "edit-field-link-remote-file-und-0-filefield-fcrl-remotefile-url" with "https://s3.amazonaws.com/fcrl-default-content-files/files/datastore-simple5.csv"
    And I press "Save"
    Given I am logged in as "Celeste"
    And I am on "Resource 01" page
    When I click "Manage Datastore"
  ...
  Scenario: Drop datastore of own resource
    ...
    And I click "Edit"
    And I click "Remote file"
    And I fill in "edit-field-link-remote-file-und-0-filefield-fcrl-remotefile-url" with "https://s3.amazonaws.com/fcrl-default-content-files/files/datastore-simple6.csv"
    And I press "Save"
    Given I am logged in as "Celeste"
    And I am on "Resource 01" page
    When I click "Manage Datastore"
  ...
  Scenario: Remote CSV preview
    Given resources:
      ...
      | Resource 01 | Katie    | Yes       | Test        | https://s3.amazonaws.com/fcrl-default-content-files/files/district_centerpoints_0.csv |
    Given I am logged in as "Katie"
    And I am on "Resource 01" page
    When I click "Edit"
    And I press "Save"
  ...
  Scenario: Image preview
    Given resources:
      | title       | author   | published | description | link file |
      | Resource 01 | Katie    | Yes       | Test        | https://s3.amazonaws.com/fcrl-default-content-files/files/geography.png |
    Given I am logged in as "Katie"
    And I am on "Resource 01" page
    When I click "Edit"
    And I press "Save"
  ...
  Scenario: ZIP preview
    Given resources:
      | title       | author   | published | description | link file |
      | Resource 01 | Katie    | Yes       | Test        | https://s3.amazonaws.com/fcrl-default-content-files/files/metadata.zip |
    Given I am logged in as "Katie"
    And I am on "Resource 01" page
    When I click "Edit"
    And I press "Save"
  ...
  Scenario: XML preview
    Given resources:
      | title       | author   | published | description | link file |
      | Resource 01 | Katie    | Yes       | Test        | https://s3.amazonaws.com/fcrl-default-content-files/files/catalog.xml |
    Given I am logged in as "Katie"
    And I am on "Resource 01" page
    When I click "Edit"
    And I press "Save"
  ...
  Scenario: JSON preview
    Given resources:
      | title       | author   | published | description | link file |
      | Resource 01 | Katie    | Yes       | Test        | https://s3.amazonaws.com/fcrl-default-content-files/files/data.json |
    Given I am logged in as "Katie"
    And I am on "Resource 01" page
    When I click "Edit"
    And I press "Save"
  ...
  Scenario: GEOJSON preview
    Given resources:
      | title       | author   | published | description | link file |
      | Resource 01 | Katie    | Yes       | Test        | https://s3.amazonaws.com/fcrl-default-content-files/files/USA.geo.json |
    Given I am logged in as "Katie"
    And I am on "Resource 01" page
    When I click "Edit"
    And I press "Save"
  ...
  Scenario: Create resource with a tsv file
    ...
    And I am on the "Content" page
    And I click "Resource"
    And I attach the drupal file "fcrl/TAB_delimiter_large_raw_number.tsv" to "files[field_upload_und_0]"
  ...
  Scenario: Create resource with a tab file
    ...
    And I am on the "Content" page
    And I click "Resource"
    And I attach the drupal file "fcrl/TAB_delimiter_large_raw_number.tab" to "files[field_upload_und_0]"
