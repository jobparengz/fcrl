...
Feature: Search
  ...
  Background:
    ...
    And datasets:
      ...
      | FCRLTest Dataset 01 | Group 02  | Gabriel | Yes       | something01  | edumication | Test 01     |
      | FCRLTest Dataset 02 | Group 01  | Gabriel | Yes       | politics01   | dazzling    | Test 02     |
    And resources:
      | title       | publisher | format | author | published | dataset             | description |
      | Resource 01 | Group 01  | csv 2  | Badmin | Yes       | FCRLTest Dataset 01 |             |
      | Resource 02 | Group 01  | html 2 | Badmin | Yes       | FCRLTest Dataset 02 |             |
