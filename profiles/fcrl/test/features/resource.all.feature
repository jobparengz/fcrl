...
Feature: Resource
  ...
  @resource_all_05 @api @fixme @testBug
    ...
    #      See:     https://github.com/GetFCRL/fcrl_datastore/blob/7.x-1.x/tests/fcrl_datastore.test
    #      And See: https://github.com/GetFCRL/fcrl_dataset/compare/310_dataset_rest_api
  ...
  #TODO: This test was relying on default fcrl content so we needed to fix it, in the next lines there is
  ...
  Scenario: Open data previews in external services
    ...
    And I fill in "edit-field-link-remote-file-und-0-filefield-fcrl-remotefile-url" with "https://s3.amazonaws.com/fcrl-default-content-files/files/district_centerpoints_0.csv"
