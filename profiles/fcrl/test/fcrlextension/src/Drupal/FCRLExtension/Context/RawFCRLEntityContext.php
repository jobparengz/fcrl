...
use Drupal\FCRLExtension\ServiceContainer\Page;
 ...
 */
class RawFCRLEntityContext extends RawFCRLContext implements SnippetAcceptingContext {
  ...
  /**
   * @var \Drupal\FCRLExtension\Context\PageContext
   */
  protected $pageContext;
  /**
   * @var \Drupal\FCRLExtension\Context\SearchAPIContext
   */
  ...
  public function gatherContexts(BeforeScenarioScope $scope) {
    ...
    $this->pageContext = $environment->getContext('Drupal\FCRLExtension\Context\PageContext');
    $this->searchContext = $environment->getContext('Drupal\FCRLExtension\Context\SearchAPIContext');
  }
  ...
  public function pre_save($wrapper, $fields) {
    ...
    $this->dispatchFCRLHooks('BeforeFCRLEntityCreateScope', $wrapper, $fields);
  ...
  public function applyMissingRequiredFields(array &$data) {
    ...
    if ($bundle == "dataset") {
      ...
      foreach ($this->field_properties as $key => $field) {
        ...
        $lang = fcrl_dataset_form_field_language($form, $key);
  ...
  public function post_save($wrapper, $fields) {
    $this->dispatchFCRLHooks('AfterFCRLEntityCreateScope', $wrapper, $fields);
   ...
   * @throws
   */
  protected function dispatchFCRLHooks($scopeType, \EntityDrupalWrapper $wrapper, &$fields) {
    $fullScopeClass = 'Drupal\\FCRLExtension\\Hook\\Scope\\' . $scopeType;
