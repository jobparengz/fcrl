...
Feature: Resource
  ...
  @resource_editor_3 @fixme @fcrlBug @noworkflow
  ...
  Scenario: Import items on datastore of resources associated with groups that I am a member of
    ...
    And I fill in "edit-field-link-remote-file-und-0-filefield-fcrl-remotefile-url" with "https://s3.amazonaws.com/fcrl-default-content-files/files/datastore-simple7.csv"
    And I press "Save"
    Given I am logged in as "Celeste"
    And I am on "Resource 02" page
    When I follow "View"
  ...
  Scenario: Delete items on datastore of resources associated with groups that I am a member of
      ...
      And I click "Edit"
      And I click "Remote file"
      And I fill in "edit-field-link-remote-file-und-0-filefield-fcrl-remotefile-url" with "https://s3.amazonaws.com/fcrl-default-content-files/files/datastore-simple8.csv"
      And I press "Save"
      Given I am logged in as "Celeste"
  ...
  Scenario: Drop datastore of resources associated with groups that I am a member of
    ...
    And I click "Edit"
    And I click "Remote file"
    And I fill in "edit-field-link-remote-file-und-0-filefield-fcrl-remotefile-url" with "https://s3.amazonaws.com/fcrl-default-content-files/files/datastore-simple9.csv"
    And I press "Save"
    Given I am logged in as "Celeste"
    And I am on "Resource 02" page
    When I click "Manage Datastore"
  ...
  @resource_editor_10 @fixme @fcrlBug @noworkflow
