...
# Don't remove! This is for avoiding issues when other scenarios are disabled (because of @noworkflow tag).
  ...
  Scenario: Viewing map preview
    ...
    And I fill in "edit-field-link-remote-file-und-0-filefield-fcrl-remotefile-url" with "https://s3.amazonaws.com/fcrl-default-content-files/files/Polling_Places_Madison_0.csv"
  ...
  Scenario: Viewing graph preview
    ...
    When I click "Edit"
    And I click "Remote file"
    And I fill in "edit-field-link-remote-file-und-0-filefield-fcrl-remotefile-url" with "https://s3.amazonaws.com/fcrl-default-content-files/files/data_0.csv"
    And I press "edit-submit"
