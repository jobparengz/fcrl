...
(function ($) {
    Drupal.behaviors.checkbox = {
        // Enforce role pairings defined in fcrl_workflow_permissions_form_user_profile_form_alter()
        attach: function (context, settings) {
            var rolePairings = settings.fcrl_workflow_permissions.rolePairings;
            var checkboxClass = settings.fcrl_workflow_permissions.checkboxClass;
