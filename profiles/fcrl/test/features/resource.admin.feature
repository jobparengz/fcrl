...
Feature: Resource
  ...
  Scenario: Delete items on datastore of any resource
    ...
    And I click "Edit"
    And I click "Remote file"
    And I fill in "edit-field-link-remote-file-und-0-filefield-fcrl-remotefile-url" with "https://s3.amazonaws.com/fcrl-default-content-files/files/datastore-simple1.csv"
    And I press "Save"
    And I am on "Resource 04" page
    When I click "Manage Datastore"
    And I press "Import"
  ...
  Scenario: Drop datastore of any resource
    ...
    And I click "Edit"
    And I click "Remote file"
    And I fill in "edit-field-link-remote-file-und-0-filefield-fcrl-remotefile-url" with "https://s3.amazonaws.com/fcrl-default-content-files/files/datastore-simple2.csv"
    And I press "Save"
    And I am on "Resource 04" page
    When I click "Manage Datastore"
    And I press "Import"
