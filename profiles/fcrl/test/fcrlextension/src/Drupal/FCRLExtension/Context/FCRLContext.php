 ...
 */
class FCRLContext extends RawFCRLContext {
...
public function iWaitForTextToDisappear($text)
{
  ...
  public function assertRedirectButton($site){
    ...
    switch($site){
      ...
      case 'Facebook':
        ...
        break;
      default:
        throw new \Exception("Not a valid site for FCRL sharing.");
    }
  ...
  {
    // Prepare data.
    $default_content_mod_path = drupal_get_path('module', 'fcrl_default_content');
