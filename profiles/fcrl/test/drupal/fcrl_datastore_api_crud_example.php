...
include 'fcrl_datastore_api_crud.php';

print_r('FCRL Datastore CRUD example: INIT.'); echo '<br/>';
// Set parameters.
$base_url = 'http://mis-fcrl';
...
$user_login = fcrl_datastore_services_user_login('admin', 'admin', $login_url);
$cookie_session = $user_login['cookie_session'];
$csrf_token = fcrl_datastore_services_get_csrf($cookie_session, $user_login['curl'], $base_url);
...
$datastore = fcrl_datastore_services_datastore_create($node_data, $csrf_token, $cookie_session, $base_url, $endpoint, $entity);
var_dump($datastore);
...
$datastore = fcrl_datastore_services_datastore_update($node_data, $datastore->datastore_id, $csrf_token, $cookie_session, $base_url, $endpoint, $entity);
...
$entity = 'data';
$datastore = fcrl_datastore_services_delete_file($datastore->datastore_id, $csrf_token, $cookie_session, $base_url, $endpoint, $entity);

var_dump($datastore);

print_r('- File deleted!.'); echo '<br/>';

print_r('FCRL Datastore CRUD example: END.');
