...
Feature: Theme
  ...
  Background:
    Given pages:
      ...
      | Settings      | /admin/appearance/settings/fishcoral_project |
    Given users:
      | name    | mail                | roles                |
  ...
  Scenario: Add custom logo
    ...
    And I attach the drupal file "fcrl/fcrl_logo.png" to "files[logo_upload]"
  ...
  Scenario: Add custom hero image
    ...
    And I attach the drupal file "fcrl/fcrl_hero.jpg" to "files[hero_file]"
    And I wait for the file upload to finish
    When I press "Save configuration"
    Then I wait for "3" seconds
    Then I should see "The configuration options have been saved"
