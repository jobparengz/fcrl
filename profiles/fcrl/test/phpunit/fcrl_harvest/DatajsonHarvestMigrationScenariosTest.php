...
class DatajsonHarvestMigrationScenariosTest extends PHPUnit_Framework_TestCase {
  ...
  public function testHarvestSourceUnchanged() {
    ...
    fcrl_harvest_migrate_source($source);
    ...
    // migration again.
    $migrationOld = fcrl_harvest_get_migration(self::getOriginalTestSource());
    ...
    // Harvest cache the test source.
    fcrl_harvest_cache_source(self::getOriginalTestSource());
    // Harvest Migration of the test data.
    fcrl_harvest_migrate_source(self::getOriginalTestSource());

    $migrationNew = fcrl_harvest_get_migration(self::getOriginalTestSource());
  ...
  public function testHarvestSourceAlternative() {
    ...
    fcrl_harvest_cache_source(self::getAlternativeTestSource());
    fcrl_harvest_migrate_source(self::getAlternativeTestSource());

    $migrationAlternative = fcrl_harvest_get_migration(self::getAlternativeTestSource());
  ...
  public function testHarvestSourceError() {
    ...
    // source XML docs. Harvest cache the test source.
    fcrl_harvest_cache_source(self::getErrorTestSource());
    fcrl_harvest_migrate_source(self::getErrorTestSource());

    $migrationError = fcrl_harvest_get_migration(self::getErrorTestSource());
  ...
  public function testHarvestSourceEmpty() {
    ...
    // source XML docs. Harvest cache the test source.
    fcrl_harvest_cache_source(self::getEmptyTestSource());
    fcrl_harvest_migrate_source(self::getEmptyTestSource());

    $migrationEmpty = fcrl_harvest_get_migration(self::getEmptyTestSource());
  ...
  public function testHarvestSourceMessagesAppend() {
    ...
    fcrl_harvest_cache_source(self::getErrorTestSource());
    fcrl_harvest_migrate_source(self::getErrorTestSource(), $options);

    $migrationErrorAfter = fcrl_harvest_get_migration(self::getErrorTestSource());
  ...
  public function testGroupsUpdate() {
    ...
    fcrl_harvest_cache_source(self::getGroupUpdatedTestSource());
    fcrl_harvest_migrate_source(self::getGroupUpdatedTestSource());
  ...
  public function testResourceRedirect() {
    ...
    fcrl_harvest_cache_source(self::getResourceWithRedirects());
    fcrl_harvest_migrate_source(self::getResourceWithRedirects());
  ...
  public function testResourceSchemeless() {
    ...
    fcrl_harvest_cache_source(self::getResourceSchemeless());
    fcrl_harvest_migrate_source(self::getResourceSchemeless());
    ...
    $migration = fcrl_harvest_get_migration(self::getResourceSchemeless());
  ...
  public function testBom() {
    // Harvest a source that have resources without scheme.
    fcrl_harvest_cache_source(self::getResourceBom());
    fcrl_harvest_migrate_source(self::getResourceBom());

    $migration = fcrl_harvest_get_migration(self::getResourceBom());
    $migrationMap = $this->getMapTableFromMigration($migration);
  ...
  public function testTemporal() {
    ...
    // Harvest the faulty source.
    fcrl_harvest_cache_source(self::getResourceTemporal());
    fcrl_harvest_migrate_source(self::getResourceTemporal());

    $migration = fcrl_harvest_get_migration(self::getResourceTemporal());
    $migrationMap = $this->getMapTableFromMigration($migration);
  ...
  public function testResourceAccessUrl() {
    // Harvest the source.
    fcrl_harvest_cache_source(self::getResourceAccessUrl());
    fcrl_harvest_migrate_source(self::getResourceAccessUrl());
    $migration = fcrl_harvest_get_migration(self::getResourceAccessUrl());
    $migrationMap = $this->getMapTableFromMigration($migration);
    $dest_ids = array_map(function ($mapRecord) {
      return $mapRecord->destid1;
    }, $migrationMap);
    ...
    $this->assertEquals("http://demo.getfcrl.com/", $resource_emw->field_link_api->url->value());
  }
  ...
  public function testNoIssued() {
    // Harvest the source.
    fcrl_harvest_cache_source(self::getResourceNoIssued());
    fcrl_harvest_migrate_source(self::getResourceNoIssued());
    $migration = fcrl_harvest_get_migration(self::getResourceNoIssued());
    $migrationMap = $this->getMapTableFromMigration($migration);
    $dest_ids = array_map(function ($mapRecord) {
      return $mapRecord->destid1;
    }, $migrationMap);
  ...
  public function testHarvestError() {
    ...
    $migrationError = fcrl_harvest_get_migration(self::getOriginalTestSource());
    ...
    // Similar test for when fcrl_dataset_metadata_source is available.
    if (!module_exists('fcrl_dataset_metadata_source')) {
      $this->markTestSkipped("fcrl_dataset_metadata_source module does not exists.");
    }
    else {
      // Clean the harvest migration data from the source.
      fcrl_harvest_rollback_sources(array(self::getOriginalTestSource()));
      fcrl_harvest_deregister_sources(array(self::getOriginalTestSource()));
  ...
  protected function tearDown() {
    ...
    fcrl_harvest_rollback_sources(array($source));
    fcrl_harvest_deregister_sources(array($source));
  ...
  public static function getOriginalTestSource() {
    return new HarvestSourceDataJsonStub(__DIR__ . '/data/fcrl_harvest_datajson_test_original.json');
  }
  ...
  public static function getAlternativeTestSource() {
    return new HarvestSourceDataJsonStub(__DIR__ . '/data/fcrl_harvest_datajson_test_alternative.json');
  }
  ...
  public static function getGroupUpdatedTestSource() {
    return new HarvestSourceDataJsonStub(__DIR__ . '/data/fcrl_harvest_datajson_test_group_updated.json');
  }
  ...
  public static function getErrorTestSource() {
    return new HarvestSourceDataJsonStub(__DIR__ . '/data/fcrl_harvest_datajson_test_error.json');
  }
  ...
  public static function getEmptyTestSource() {
    return new HarvestSourceDataJsonStub(__DIR__ . '/data/fcrl_harvest_datajson_test_empty.json');
  }
  ...
  public static function getNoResourceTestSource() {
    return new HarvestSourceDataJsonStub(__DIR__ . '/data/fcrl_harvest_datajson_test_no_resources.json');
  }
  ...
  public static function getResourceWithRedirects() {
    return new HarvestSourceDataJsonStub(__DIR__ . '/data/fcrl_harvest_datajson_test_redirects.json');
  }
  ...
  public static function getResourceSchemeless() {
    return new HarvestSourceDataJsonStub(__DIR__ . '/data/fcrl_harvest_datajson_test_schemeless_resource.json');
  }
  ...
  public static function getResourceTemporal() {
    return new HarvestSourceDataJsonStub(__DIR__ . '/data/fcrl_harvest_datajson_test_temporal.json');
  }
  ...
  public static function getResourceNoIssued() {
    return new HarvestSourceDataJsonStub(__DIR__ . '/data/fcrl_harvest_datajson_test_noissued.json');
  }
  ...
  public static function getResourceAccessUrl() {
    return new HarvestSourceDataJsonStub(__DIR__ . '/data/fcrl_harvest_datajson_test_resource_accessurl.json');
  }
  ...
  public static function getResourceBom() {
    return new HarvestSourceDataJsonStub(__DIR__ . '/data/fcrl_harvest_datajson_test_bom.json');
  }
  ...
  private function getTestDatasetNid($source) {
    $migration = fcrl_harvest_get_migration($source);
