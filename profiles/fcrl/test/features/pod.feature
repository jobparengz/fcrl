...
Feature: Project Open Data + Open Data Federal Extras
  ...
  Scenario: See all POD required fields marked as required
    ...
    Given I "enable" the "Strict POD validation" on FCRL Dataset Forms
    And I "enable" the "Groups validation" on FCRL Dataset Forms
    ...
    Then I "disable" the "Strict POD validation" on FCRL Dataset Forms
    Then I "disable" the "Groups validation" on FCRL Dataset Forms
  ...
  Scenario: See only POD valid licenses if POD validation is enabled
    ...
    #Cleanup configuration
    Given I "disable" the "Strict POD validation" on FCRL Dataset Forms
