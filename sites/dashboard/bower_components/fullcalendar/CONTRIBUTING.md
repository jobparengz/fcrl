...
In the description of your [Pull Request][Using Pull Requests], please include recreation steps for the bug as well as a [JSFiddle/JSBin] mis. Communicating the buggy behavior is a requirement before a merge can happen.
...
After you make code changes, you'll want to compile the JS/CSS so that it can be previewed from the tests and miss. You can either manually rebuild each time you make a change:
